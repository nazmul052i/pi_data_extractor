...
class EnhancedPIDataExtractorGUI(QWidget):
    ...
    def apply_modern_theme(self):
        """Apply enhanced modern theme with better spacing and colors - Fixed CSS"""
        self.setStyleSheet("""
            QWidget {
    ...
    def setup_ui(self):
        ...
        # Left panel (controls) - Enhanced with better sizing
        left_panel = self.create_control_panel()
        left_panel.setFixedWidth(400)  # Slightly reduced width for better balance
    ...
    def create_connection_card(self):
        ...
        self.connect_btn.setStyleSheet(self.get_enhanced_button_style("#28A745"))
        
        self.disconnect_btn = ModernButton("⏹ Disconnect", color="#DC3545")
        self.disconnect_btn.setMinimumHeight(44)
        self.disconnect_btn.setEnabled(False)
        self.disconnect_btn.setStyleSheet(self.get_enhanced_button_style("#DC3545"))
    ...
    def create_time_card(self):
        ...
        for btn in [self.last_hour_btn, self.last_day_btn, self.last_week_btn]:
            ...
            btn.setStyleSheet(self.get_enhanced_button_style("#9C27B0"))
    ...
    def create_extraction_card(self):
        ...
        self.fetch_btn.setStyleSheet(self.get_enhanced_button_style("#007BFF", large=True))
    ...
    def create_export_card(self):
        ...
        self.browse_btn.setStyleSheet(self.get_enhanced_button_style("#6C757D"))
        ...
        self.export_btn.setStyleSheet(self.get_enhanced_button_style("#28A745"))
    ...
    def get_enhanced_button_style(self, color, large=False):
        """Get enhanced button styling - Fixed version without transform"""
        font_size = "14px" if large else "13px"
        padding = "14px 20px" if large else "12px 16px"
        
        # Create lighter and darker variants using QColor
        color_obj = QColor(color)
        light_color = color_obj.lighter(110).name()
        dark_color = color_obj.darker(110).name()
    ...
    def create_right_panel(self):
        """Create the right panel with tabs - unchanged from original"""
    ...
    # ALL REMAINING METHODS FROM ORIGINAL FILE - Keep exactly as they were
