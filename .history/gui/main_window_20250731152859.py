...
class EnhancedPIDataExtractorGUI(QWidget):
    ...
    # 3. Remove the duplicate setup_export_formats method - it's not needed
    # The format combo is set up directly in create_control_panel()


    # 4. Your browse_export_path method looks correct already:
