...
class ZoomableChartView(QChartView):
    """Enhanced chart view with zoom capabilities and right-click reset"""
    def __init__(self, chart, parent=None):
        ...
        # Store original ranges after chart is rendered
    ...
    def store_original_ranges(self):
        ...
        try:
            ...
            print(f"Warning: Could not store original ranges: {e}")
    ...
    def reset_zoom(self):
        ...
        try:
            ...
            print(f"Warning: Could not reset zoom: {e}")
