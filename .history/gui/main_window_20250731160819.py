...
class EnhancedPIDataExtractorGUI(QWidget):
    ...
    def apply_modern_theme(self):
        """Apply modern theme with proper styling"""
        self.setStyleSheet("""
            QWidget {
            ...
            QLineEdit:hover, QComboBox:hover, QSpinBox:hover, QDateTimeEdit:hover {
                border-color: #B0B0B0;
            }
    ...
    def create_control_panel(self):
        """Create the left control panel with proper styling and layout"""
        scroll = QScrollArea()
        ...
        # Connection Card
        connection_card = QGroupBox("🌐 PI Server Connection")
        ...
        # Server input with proper label
        server_label = QLabel("Server Name:")
        server_label.setStyleSheet("font-weight: bold; color: #555; margin-bottom: 2px;")
        ...
        # Connection buttons in horizontal layout
        ...
        time_card = QGroupBox("⏰ Time Configuration")
        time_layout = QVBoxLayout()
        time_layout.setSpacing(10)
        
        # Time inputs in a grid for better organization
        ...
        start_label.setStyleSheet("font-weight: bold; color: #555;")
        ...
        time_grid.addWidget(self.start_time, 0, 1)
        
        # End time
        end_label = QLabel("End Time:")
        end_label.setStyleSheet("font-weight: bold; color: #555;")
        ...
        time_grid.addWidget(self.end_time, 1, 1)
        
        # Interval
        interval_label = QLabel("Interval:")
        interval_label.setStyleSheet("font-weight: bold; color: #555;")
        self.interval_input = QComboBox()
        self.interval_input.addItems(["1m", "5m", "15m", "30m", "1h", "4h", "8h", "1d"])
        
        time_grid.addWidget(interval_label, 2, 0)
        time_grid.addWidget(self.interval_input, 2, 1)
        
        # Timezone
        timezone_label = QLabel("Timezone:")
        timezone_label.setStyleSheet("font-weight: bold; color: #555;")
        self.timezone_combo = QComboBox()
        self.timezone_combo.addItems(["Local", "UTC", "US/Central", "US/Eastern", "US/Pacific"])
        
        time_grid.addWidget(timezone_label, 3, 0)
        time_grid.addWidget(self.timezone_combo, 3, 1)
        ...
        quick_label.setStyleSheet("font-weight: bold; color: #555;")
        ...
        quick_layout.addWidget(self.last_week_btn)
    ...
    # CORRECTED: Include all four formats
    self.format_combo.addItems([".csv", ".tsv", ".txt", ".iq"])
    format_layout.addWidget(self.format_combo)
    export_layout.addLayout(format_layout)

    # CORRECTED: Update tooltip to include TSV
    ...
    export_layout.addWidget(self.format_tooltip_label)
        ...
        mode_label.setStyleSheet("font-weight: bold; color: #555;")
        ...
        self.inferential_instructions = QLabel(
            ...
            "• Use 'Mark as Lab Tags' button\n"
            "• Lab tags determine sample times\n"
            "• Process tags averaged around lab samples"
        )
        ...
        window_layout.setHorizontalSpacing(10)

        past_label = QLabel("Past Window (min):")
        past_label.setStyleSheet("font-weight: bold; color: #555; font-size: 11px;")
        ...
        future_label.setStyleSheet("font-weight: bold; color: #555; font-size: 11px;")
        ...
        # Export Options Card
        export_card = QGroupBox("💾 Export Options")
        export_layout = QVBoxLayout()
        ...
        # Format tooltip
        self.format_tooltip_label = QLabel("ℹ️ CSV: Excel compatible | TXT: DMC format with status")
        ...
        self.browse_btn = ModernButton("📁 Browse", color="#607D8B")
